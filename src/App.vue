            ...
            <button @click="openMenu = !openMenu" :class="openMenu ? 'bg-[#282828]' : 'bg-black'"
                ...
                <div class="flex items-center">
                    <img 
                      class="rounded-full" 
                      width="27"
                      src="https://lh3.googleusercontent.com/a/ACg8ocKFmO8hWfq2HAl1OnGjDff3VYXGViCM73xi_GFy923qtGcZfANxDQ=s519-c-no"
                    >
                    <div class="text-white text-[14px] ml-1.5 font-semibold">Sandesh </div>
