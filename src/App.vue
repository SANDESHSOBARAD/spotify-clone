  ...
  <div>
    ...
    <button 
      ...
      <div class="flex items-center">
        <img src="https://lh3.googleusercontent.com/a/ACg8ocKFmO8hWfq2HAl1OnGjDff3VYXGViCM73xi_GFy923qtGcZfANxDQ=s519-c-no" class="rounded-full" width="27">
    ...
    <div
    id="SideNav"
    class="h-[100%] p-6 w-[240px] bg-black fixed z-50"
    >
      <router-link to="/">
